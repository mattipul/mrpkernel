...
i586-elf-as ./src/irq/irq_clock_wrapper.as ./src/irq/irq_divide_by_zero_wrapper.as -o ./compile/irq_wrappers.o
...
i586-elf-gcc -T ./compile/linker.ld -o ./bin/kernel.bin -ffreestanding -O2 -nostdlib ./compile/boot.o ./compile/kernel_main.o ./compile/kernel_debug.o ./compile/memory.o ./compile/kernel.o ./compile/irq.o ./compile/irq_wrappers.o ./compile/process.o ./compile/scheduler.o 
