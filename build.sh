...
i586-elf-gcc -T ./compile/linker.ld -o ./bin/kernel.bin -ffreestanding -O2 -nostdlib ./compile/boot.o ./compile/kernel_main.o ./compile/kernel_debug.o ./compile/io_memory.o ./compile/memory_map.o ./compile/memory_handler.o ./compile/memory.o ./compile/kernel.o
